...
> **Aggiunta locale di TrappArchive** (l'unica modifica a questo file): prima
> di usare questa skill leggi `PROFILO-TRAPPARCHIVE.md` nella stessa cartella.
> Dice quali di questi documenti valgono per un'app che gira solo nel browser
> e quali no, perché qui non esistono binari, IPC, RPC né autenticazione.
